  ...
  sectionContact.innerHTML = `
    <section class="section-contact" id="contact">
        ...
        <div class="textwrapper">
            <h2>Kontakt</h2>
            <p id="contact-content"> Wer uns für eine Geburtstagsfeier, eine Hochzeit, einen Gig im eigenen Wohnzimmer oder auf großer Bühne, drinnen oder draußen (unplugged oder verstärkt) buchen möchte, schreibt uns am besten eine Nachricht an:</p>
